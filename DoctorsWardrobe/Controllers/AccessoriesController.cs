...
using DoctorsWardrobe.Models;

namespace DoctorsWardrobe.Controllers
{
    public class AccessoriesController : Controller
    {
        private DoctorsWardrobeContext db = new DoctorsWardrobeContext();
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,AccessoryName,AccessoryPhotoURL,AccessoryType,ColorID,OccasionID,SeasonID")] Accessory accessory)
        {
            ...
            ViewBag.ColorID = new SelectList(db.Colors, "ColorID", "ColorFamily", accessory.ColorID);
            ViewBag.OccasionID = new SelectList(db.Occasions, "OccasionID", "OccasionType", accessory.OccasionID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,AccessoryName,AccessoryPhotoURL,AccessoryType,ColorID,OccasionID,SeasonID")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
