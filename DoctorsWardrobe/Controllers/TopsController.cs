...
namespace DoctorsWardrobe.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,TopName,TopPhotoURL,TopType,ColorID,OccasionID,SeasonID")] Top top)
        {
            ...
            ViewBag.ColorID = new SelectList(db.Colors, "ColorID", "ColorFamily", top.ColorID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,TopName,TopPhotoURL,TopType,ColorID,OccasionID,SeasonID")] Top top)
        {
            if (ModelState.IsValid)
            {
